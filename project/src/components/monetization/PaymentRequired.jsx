...
function PaymentRequired() {
  ...
  useEffect(() => {
    const fetchAppIdAndPrices = async () => {
      try {
        ...
        const response = await fetch(`https://db.madewithmanifest.com/stripe/prices/${fetchedAppId}`)
  ...
  const handleSelectPrice = (price) => {
    ...
    const checkoutUrl = `https://db.madewithmanifest.com/stripe/checkout/${appId}/prices/${price.id}`
